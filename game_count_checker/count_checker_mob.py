...
ws = create_connection(const_file.WS_URL_MOB)
dict_games_page = [const_file.TOP_GAMES_MOB, const_file.NEW_GAMES_MOB, const_file.RECOMMENDED_GAMES_MOB]
games_list = []
games_id_list = {}
games_id = {}
a = []
...
for i in prod_list:
    if i is not games_id_list.keys():
        j = i + " : " + f"https://m.bet-boom.com/{country}/game/{games_id_list[i]}/"
        a.append(j)
